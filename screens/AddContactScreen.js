  ...
  const handleSave = async () => {
    ...
    try {
      await database.execute(
        `INSERT INTO contactos (nombre, telefono, email, categoria, notas) VALUES (?, ?, ?, ?, ?)`,
        [
          fields.nombre,
          fields.telefono,
          fields.email,
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Añadir Nuevo Contacto</Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.dropdown}>
          ...
          />
          {/* En producción usar un selector completo */}
        </View>
